...
public class TradeOrder
{
     ...
     * @throws java.lang.IllegalArgumentException - if shares is greater than the number of shares in this order.
     */
    public void subtractShares(int shares)
    {
        ...
        {
            throw new IllegalArgumentException("shares are greater than the number of shares in this order");
        }
    }
