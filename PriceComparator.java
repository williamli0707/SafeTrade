...
public class PriceComparator implements java.util.Comparator<TradeOrder>
{
     ...
     * ascending or descending order. The order of comparison depends
     * on the value of a given parameter. Sets the private boolean ascending flag to asc.
     * @param asc
     */
     ...
     * order1 and order2 are limit orders. In the latter case, 
     * the difference returned is cents1 - cents2 or cents2 - cents1, 
